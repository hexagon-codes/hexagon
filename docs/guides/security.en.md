...
The bridge consumes ai-core v0.2.11's `llm.Usage` directly. The Controller uses toolkit v0.3.4's sliding-window limiter internally; limiter-construction failures are normalized as Controller configuration errors.
